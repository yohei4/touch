...
@section('title', '店舗情報')
@section('content')
    <div class="form-outer" id="restaurant-info">
        {{-- <form action="{{ route('restaurant_information/update') }}" id="restaurant-information" class="form" method="post" enctype="multipart/form-data">
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="restaurant_name">店舗名</label>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="postal_code">郵便番号</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="address_1">都道府県</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="address_2">市区町村</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="address_3">番地</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="address_4">建物名・部屋番号</label>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="tel">電話番号</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="comment">店舗の説明</label>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="table_count">テーブル数</label>
                    <span class="form-required"></span>
                </div>
            ...
            <div class="form-item">
                <div class="form-item__label">
                    <label class="form-item__label--txt" for="table_count">ロゴ写真</label>
                </div>
